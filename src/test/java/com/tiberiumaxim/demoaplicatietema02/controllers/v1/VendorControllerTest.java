...
import com.tiberiumaxim.demoaplicatietema02.services.VendorService;
...
class VendorControllerTest {
    ...
    void updateVendor() throws Exception {
        ...
        given(vendorService.saveByVendorDTO(anyLong(), any(VendorDTO.class))).willReturn(vendorDTO1);
